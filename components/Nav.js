...
const Nav = () => {
  ...
  return (
    <nav className='flex flex-col bottom-0 z-50 top-0 xl:h-full  w-full xl:w-16 xl:max-w-md  mt-auto xl:right-[2%] h-max xl:justify-center items-center gap-y-4 fixed'>
      {/* inner */}
